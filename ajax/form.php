...
<head>
    ...
    <meta charset="utf-8" />
<link rel="stylesheet" type="text/css" href="ajax_form.css">
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  header('Location: ajax_submit.php');
  exit();
  }
...
?>
 ...
 <form method="post" id="shop_form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
  ...
  <fieldset>
    ...
    First: <br /><input type="text" id="first" name="first" value=""><span class="error">* <?php echo $firstErr;?></span><div id="first_box"></div> <br />Last: <br /><input type="text" id="last" name="last" value=""><span class="error">* <?php echo $lastErr;?></span><div id="last_box"></div> <br />
    Email: <br /><input type="email" id="email" name="email" value=""><span class="error">* <?php echo $emailErr;?></span><div id="email_box"></div> <br />
  </fieldset>
  <fieldset>
...
function selectFirst(first,last,email) {
$("#first").val(first);
$("#last").val(last);
$("#email").val(email);
$("#first_box").hide();
...
//To select country name
function selectLast(first, last, email) {
$("#first").val(first);
$("#last").val(last);
$("#email").val(email);
$("#last_box").hide();
...
function selectEmail(first, last,email) {
$("#first").val(first);
$("#last").val(last);
$("#email").val(email);
$("#email_box").hide();
